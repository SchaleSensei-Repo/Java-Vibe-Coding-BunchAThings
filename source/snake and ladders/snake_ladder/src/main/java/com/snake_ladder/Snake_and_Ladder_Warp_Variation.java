...
public class Snake_and_Ladder_Warp_Variation extends JFrame {
    ...
    public Snake_and_Ladder_Warp_Variation() {
    ...
    SwingUtilities.invokeLater(Snake_and_Ladder_Warp_Variation::new);
}
}